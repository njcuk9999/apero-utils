...
def get_bervs(obstime, coordtime, ra, dec, pmra, pmde, plx,
    ...
    :param obstime: numpy array of JD dates (observation time)
...
def get_berv(obstime, coordtime, ra, dec, pmra, pmde, plx,
    ...
    berv, _ = helcorr(jd=obstime, ra2000=ra2000, dec2000=dec2000,
                        obs_long=obs_long, obs_lat=obs_lat, obs_alt=obs_alt)
