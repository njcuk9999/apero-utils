...
# software aliases
alias dfits="/project/$APERO_PROJECT_ID/apero/nirps_bin/scripts/fitsio/dfits"
alias fitsort="/project/$APERO_PROJECT_ID/apero/nirps_bin/scripts/fitsio/fitsort"
